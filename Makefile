...
#
# This <strong class="highlight">makefile</strong> will correctly identify the files and produce:
#
#   linked_list.o
#   test_linked_list.o
#
...
#
#-----------------------------------------------------------------------------
# When MIXING <strong class="highlight">C</strong> and <strong class="highlight">C++</strong> modules, this <strong class="highlight">makefile</strong> will compile the <strong class="highlight">C</strong> modules
# with the <strong class="highlight">C</strong> compiler, and the <strong class="highlight">C++</strong> modules with the <strong class="highlight">C++</strong> compiler. Keep that
...
# general options
#-----------------------------------------------------------------------------
# These are the names of the <strong class="highlight">C</strong> and <strong class="highlight">C++</strong> compilers to use, and options common
# to both compilers.
#
...
# "foo.cxx" (<strong class="highlight">or</strong> whatever the specified extention is) exists then "foo.o"
...
#   by '(' appears and does not have a '/*' <strong class="highlight">or</strong> '//' at the beginning of the
#   line.
#
...
$(BIN_NAME): $(ALL_OBJS) $(filter $(BIN_NAME).h, $(wildcard *.h))
	$(CC) $(CFLAGS) $(ALL_OBJS) $(IFLAGS) $(LDFLAGS) -o $(BIN_NAME)
