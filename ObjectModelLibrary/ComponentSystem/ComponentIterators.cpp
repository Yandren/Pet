...
void CComponentByInterfaceIterator::SetToFirstValidComponent()
{
	...
	const int32_t numComponentTypes = static_cast<int32_t>(db.mInterfaceTypeToComponentTypes[mInterfaceType].size());
...
CComponentByObjectIterator::CComponentByObjectIterator(CObjectIdHash oId) : mObjectId(oId), mIndex(0)
{
	SetToFirstValidComponent();
}
